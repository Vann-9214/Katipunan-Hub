...
import {
  ...
  MenuType,
  DBEvent,
} from "@/components/General/Calendar/types";
import EventModal from "@/components/General/Calendar/EventModal";
import ReminderPanel from "@/components/General/Calendar/ReminderPanel";
import SchedulePanel from "@/components/General/Calendar/SchedulePanel";
import LoadingScreen from "@/components/ReusableComponent/LoadingScreen";
import CalendarMenu from "@/components/General/Calendar/CalendarMenu";
import CalendarViews from "@/components/General/Calendar/CalendarViews";
import { getPhilippineHolidays } from "@/components/General/Calendar/calendarUtils";
