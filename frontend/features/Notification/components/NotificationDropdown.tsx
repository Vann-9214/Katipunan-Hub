...
import { NotificationItem, clearAllUserNotifications } from "@/database/supabase/Notification";
...
export default function NotificationDropdown({
  ...
  const handleClearAll = async () => {
    ...
    const { error } = await clearAllUserNotifications(user.id);
    if (error) {
