...
export default function EditMainProfileModal({
  ...
  // State: Default to user data or null
  ...
  // Helper to check if a valid custom image exists
  // Returns true if preview exists AND it is not the default placeholder
  ...
  const handleRemoveAvatar = () => {
    ...
    setAvatarPreview(null); // This will cause UI to fallback to DefaultAvatar
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg flex flex-col max-h-[90vh]">
        ...
        >
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center">
              <h3 className="font-bold text-lg text-gray-800">Cover Photo</h3>
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center">
              ...
              <div className="flex items-center gap-3">
                {/* Explicit check for custom avatar to show remove button */}
                {hasCustomAvatar && (
                  <button
                    type="button"
            ...
            <div className="flex justify-center">
              <div className="relative w-32 h-32 rounded-full overflow-hidden border-4 border-white shadow-md bg-gray-100 group">
                <Image
        ...
        <div className="p-5 border-t border-gray-100 flex justify-end gap-3">
          <button
            onClick={onClose}
            disabled={isSaving}
            className="px-5 py-2.5 border border-gray-200 text-gray-600 font-bold rounded-xl hover:bg-gray-50 transition-colors cursor-pointer disabled:opacity-50"
          >
            Cancel
          </button>
          <button
            onClick={handleSave}
            disabled={isSaving}
            className="px-6 py-2.5 bg-[#8B0E0E] text-white font-bold rounded-xl hover:bg-[#6d0b0b] transition-all shadow-lg shadow-red-900/20 flex items-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed cursor-pointer"
          >
