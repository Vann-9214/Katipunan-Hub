...
import { Instagram, Facebook, ArrowLeft, ArrowRight } from "lucide-react";
  ...
  return (
    <div className="min-h-screen w-full relative overflow-x-hidden font-sans">
      ...
      <style jsx global>{`
        ...
        .flip-inner {
          animation: text-flip 6s cubic-bezier(0.23, 1, 0.32, 1.2) infinite;
        }
        @keyframes text-flip {
          0% {
            margin-top: 0;
      ...
      <div className="sticky top-0 h-screen w-full bg-[#EFBF04] overflow-hidden flex flex-col pt-20 z-0">
        ...
        <motion.div
          ...
          className="absolute top-0 left-0 w-[145%] h-[145%] lg:w-[78vw] lg:h-screen bg-[#A52A2A] z-0 opacity-50 rounded-br-[100%] rounded-tr-[25%]"
        />
        <motion.div
          initial={{ scale: 1.2, x: -100, y: -100, opacity: 0 }}
          animate={{ scale: 1, x: 0, y: 0, opacity: 1 }}
          transition={{ duration: 1.8, ease: "easeOut" }}
          className="absolute top-0 left-0 w-[140%] h-[140%] lg:w-[75vw] lg:h-screen bg-[#8B0E0E] z-0 shadow-2xl rounded-br-[100%] rounded-tr-[20%]"
        />
        ...
        <div className="relative z-10 flex-1 flex flex-col lg:flex-row items-center justify-center lg:justify-between px-6 lg:px-24 pt-10 lg:pt-0">
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="flex flex-col items-start max-w-3xl select-none mt-10 lg:mt-0 relative z-40"
          >
                ...
                <div className="flex flex-wrap items-baseline gap-3 lg:gap-6 text-[64px] lg:text-[96px] font-bold tracking-tight">
                  ...
                  <div className="flip-container inline-block align-bottom relative">
                    <div className="flip-inner flex flex-col">
                      <div className="h-[1.2em] flex items-center text-[#EFBF04]">
                        UPDATED
                      </div>
                      <div className="h-[1.2em] flex items-center text-[#EFBF04]">
                        CONNECTED
            ...
            <motion.p
              ...
              className="text-[18px] lg:text-[24px] text-gray-200 font-medium mt-8 mb-8 max-w-lg font-ptsans leading-relaxed"
            >
              From school events to lost & found, Katipunan Hub keeps the whole{" "}
              <span className="text-[#EFBF04] font-bold">CIT community</span> in
              one place.
            </motion.p>
          ...
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="hidden lg:flex relative w-[600px] h-[600px] items-center justify-center pointer-events-none"
          >
            ...
            <motion.div
              variants={itemVariants}
              className="absolute top-20 right-0 z-30 pointer-events-auto"
            >
              <motion.div variants={floatingVariant} animate="float">
                <GlassCard className="holographic-card p-5 rotate-6 hover:rotate-0 transition-transform duration-500 group">
                  <Image
                    src="/Chat.svg"
                    alt="Chat"
                    width={60}
            ...
            <motion.div
              variants={itemVariants}
              className="absolute top-40 left-0 z-30 pointer-events-auto"
            >
              <motion.div variants={floatingVariant} animate="float">
                <GlassCard className="holographic-card p-5 hover:scale-110 transition-transform duration-500 group">
                  <Image
                    src="/found.svg"
                    alt="Found"
                    width={70}
            ...
            <motion.div
              variants={itemVariants}
              className="absolute bottom-12 left-10 z-30 pointer-events-auto"
            >
              <motion.div variants={floatingVariant} animate="floatReverse">
                <GlassCard className="holographic-card p-5 -rotate-6 hover:rotate-0 transition-transform duration-500 group">
                  <Image
                    src="/Calendar.svg"
                    alt="Calendar"
            ...
            <motion.div
              variants={itemVariants}
              className="absolute bottom-24 right-20 z-30 pointer-events-auto"
            >
              <motion.div variants={floatingVariant} animate="floatReverse">
                <GlassCard className="holographic-card p-4 rotate-3 hover:-rotate-3 transition-transform duration-500 group">
                  <Image
                    src="/Bellplus.svg"
                    alt="Notify"
                    width={50}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                <div className="relative aspect-[4/3] w-full bg-white rounded-[30px] overflow-hidden shadow-xl border border-white flex items-center justify-center">
                  <p className="text-gray-400 font-montserrat text-xl">
                    Our pic together 3 of us
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="space-y-8 font-montserrat text-gray-800 text-lg leading-relaxed text-justify relative">
                  <p>
                    We built Katipunan Hub because we wanted to solve a problem
                    that many students face every day. Important updates and
                    resources were scattered, often buried in Facebook groups
                    like CIT Confessions.
                  </p>
                  <p>
                    This project is not only our answer to that problem but also
                    our stepping stone as aspiring programmers. By creating
                    Katipunan Hub, we are learning how to turn ideas into real
                    solutions that can make a difference for our community.
                  </p>
                </div>
              </motion.div>
            </div>
        ...
        >
          <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              >
                <h2 className="text-[#EFBF04] font-bold text-[48px] lg:text-[56px] leading-tight mb-8 drop-shadow-md font-montserrat">
                ...
                <div className="space-y-6 text-lg leading-relaxed text-justify font-medium font-montserrat text-gray-800">
                  <p>
                    As students at CIT we experienced firsthand how scattered
                    and messy important information could be. Whenever we needed
                    updates we often turned to Facebook groups like CIT
                    Confessions or CIT - U official page.
                  </p>
                  <p>
                    Over time this made it harder to find what truly mattered. A
                    simple lost ID could get buried under dozens of unrelated
                    posts. Announcements about events and deadlines were easy to
                    miss because they blended in with casual discussions.
                  </p>
                </div>
              </motion.div>
              ...
              >
                <div className="bg-white rounded-[20px] shadow-[0_10px_40px_-10px_rgba(0,0,0,0.1)] h-[240px] flex items-center justify-center transform hover:scale-[1.02] transition-transform duration-300 border border-gray-50 relative overflow-hidden group">
                  ...
                  <p className="text-gray-400 font-montserrat font-medium text-lg relative z-10">
                    Problem pic sa page
                  </p>
                </div>
                <div className="bg-white rounded-[20px] shadow-[0_10px_40px_-10px_rgba(0,0,0,0.1)] h-[240px] flex items-center justify-center transform hover:scale-[1.02] transition-transform duration-300 border border-gray-50 relative overflow-hidden group">
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
            ...
            >
              <div className="bg-white rounded-[20px] shadow-xl h-[240px] flex items-center justify-center border border-white relative overflow-hidden">
                ...
                <p className="text-gray-400 font-montserrat font-medium text-lg z-10">
                  Solution pic sato system
                </p>
              </div>
              <div className="bg-white rounded-[20px] shadow-xl h-[240px] flex items-center justify-center border border-white relative overflow-hidden">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-[#8B0E0E] font-bold text-[48px] lg:text-[56px] leading-tight mb-10 drop-shadow-sm font-montserrat">
              ...
              <div className="space-y-6 text-lg leading-relaxed text-justify text-gray-800 font-montserrat relative">
                <p>
                  Seeing how information was always buried and scattered pushed
                  us to think differently. We wanted something that would make
                  life easier not only for us but for every student at CIT.
                </p>
                <p>
                  Instead of scrolling through endless anonymous posts just to
                  find one important update we imagined a platform where
                  everything was already in its right place. Announcements would
                  have their own space. Lost and found items would be easy to
                  track.
                </p>
              </div>
            </motion.div>
        ...
        >
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
            <div className="mb-12 text-center">
              <h2 className="text-white font-montserrat font-bold text-[48px] drop-shadow-lg">
                Get to Know Us
              </h2>
              <p className="text-gray-300 mt-4 font-montserrat">
                The minds behind Katipunan Hub.
              </p>
            </div>
                    ...
                    <div className="bg-white rounded-[35px] overflow-hidden shadow-2xl h-full text-black transition-all duration-300 select-none">
                      <div className="h-[190px] bg-gray-200 relative flex items-center justify-center">
                        {member.image ? (
                          ...
                          <p className="font-montserrat text-gray-500 text-lg font-medium">
                            (Image Nato)
                          </p>
                        )}
                      </div>
                      <div className="p-6 text-left">
                        <h3 className="text-2xl font-bold font-montserrat mb-1">
                          {member.name}
                        </h3>
                        <p className="text-gray-600 font-medium text-sm mb-4 font-montserrat">
                          {member.role}
                        </p>
                        <p className="text-gray-700 text-sm mb-4 leading-relaxed font-ptsans line-clamp-4">
                          {member.bio}
                        </p>
                        <div className="mb-6">
                          <p className="text-xs font-bold text-[#8B0E0E] uppercase tracking-wider mb-1">
                            Skills
                          </p>
