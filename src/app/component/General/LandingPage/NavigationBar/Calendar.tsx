    ...
    return (
      ...
      >
        <div className="text-center font-bold text-sm text-[#800000] mb-1">
          {new Date(year, monthIndex).toLocaleString("default", { month: "short" })}
        </div>
    ...
    <div className="relative min-h-screen bg-white flex flex-col">
        ...
        >
          {[
            ...
            <div
              ...
              className={`flex items-center gap-2 w-full px-3 py-2 rounded-md cursor-pointer ${ptSans.className} text-[17px] text-black font-normal ${
      ...
      <div className="relative flex flex-col px-[66px] pt-[40px]">
        ...
        <div className="relative mt-[30px] w-[922px]">
          ...
          >
            <button onClick={prevMonth} className="hover:text-[#FFD700] transition">
              <ChevronLeft size={28} />
            </button>
            <span>
              {viewMode === "month" ? `${monthName} ${year}` : year}
            </span>
            <button onClick={nextMonth} className="hover:text-[#FFD700] transition">
                ...
                {daysArray.map((day, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {day && (
                        <span
                          className={`${ptSans.className} text-[14px] font-bold absolute top-[8px] left-1/2 -translate-x-1/2 ${
                            selectedDay === day
                              ? "text-[#FFD700]"
                              : "text-[#800000]"
                          }`}
