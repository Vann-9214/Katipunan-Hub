...
// Local imports from the new shared file
import {
  AuthMode,
  GlassCard,
  containerVariants,
...
/**
 * Combines all five major landing page sections (Hero, About Us, Problem, Solution, Team/Footer).
 */
        ...
        <div className="relative z-10 flex-1 flex flex-col lg:flex-row items-center justify-center lg:justify-between px-6 lg:px-24 pt-32 lg:pt-0">
          ...
          <div className="hidden lg:flex relative w-[600px] h-[600px] items-center justify-center pointer-events-none">
            ...
            <motion.div
              variants={floatingVariant}
              animate="floatReverse"
              className="absolute bottom-10 right-24 z-30"
            >
      ...
      <section className="w-full flex flex-col relative">
        ...
        <div className="relative h-[500px] w-full bg-[#5A0505] flex flex-col items-center justify-center overflow-hidden shrink-0 z-0">
          ...
          <div className="z-10 text-center relative mt-10">
            <h2 className="text-white font-bold font-montserrat text-[50px] drop-shadow-2xl">
              About Us
            </h2>
          </div>
        </div>
              ...
              <div className="w-full lg:w-[55%] flex flex-col z-20">
                ...
                >
                  <div className="w-full h-full rounded-[20px] border-2 border-dashed border-gray-200 flex items-center justify-center bg-gray-50 min-h-[400px]">
                    <p className="text-gray-400 font-montserrat text-xl font-medium">
              ...
              <div className="w-full lg:w-[45%] z-10 flex flex-col justify-center">
                ...
                >
                  ...
                  <div className="space-y-8 font-montserrat text-gray-800 text-lg leading-relaxed text-justify">
                    <p>
                      We built Katipunan Hub because we wanted to solve a
                      problem that many students face every day. Important
                      updates and resources were scattered, often buried in
                      Facebook groups like CIT Confessions where lost and found
                      posts, announcements, and discussions all mixed together.
                      We felt the need for a space where everything important
                      could finally come together in one place.
                    </p>
                    <p>
                      This project is not only our answer to that problem but
                      also our stepping stone as aspiring programmers. By
                      creating Katipunan Hub, we are learning how to turn ideas
                      into real solutions that can make a difference for our
                      community. What started as a project for three students
                      has become a platform that represents both our growth and
                      our vision to reach greater heights in programming and
                      beyond.
                    </p>
                  </div>
                </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-8 flex flex-col lg:flex-row items-center gap-20 z-10">
          ...
          <div className="w-full lg:w-1/2 text-white font-montserrat">
            ...
            <div className="space-y-6 text-lg leading-relaxed text-justify font-medium">
              <p>
                As students at CIT we experienced firsthand how scattered and
                messy important information could be. Whenever we needed updates
                we often turned to Facebook groups like CIT Confessions or CIT -
                U official page. While these groups gave us a space to share
                they also turned into a mix of announcements, lost and found
                posts, anonymous confessions and student conversations all in
                one place.
              </p>
              <p>
                Over time this made it harder to find what truly mattered. A
                simple lost ID could get buried under dozens of unrelated posts.
                Announcements about events and deadlines were easy to miss
                because they blended in with casual discussions. What should
                have been a reliable source of information turned into a
                confusing mix that left many students frustrated.
              </p>
              <p>
                We knew there had to be a better way to keep our community
                informed without losing the connection that made us feel part of
                something bigger.
              </p>
            </div>
          </div>
          ...
          <div className="w-full lg:w-1/2 flex flex-col gap-8">
            ...
            <div className="bg-white rounded-[20px] shadow-lg h-[280px] flex items-center justify-center transform hover:scale-[1.02] transition-transform duration-300">
              <p className="text-gray-400 font-montserrat font-medium text-lg">
                Problem pic sa page
              </p>
            </div>
            {/* Bottom Image Card */}
        ...
        <div className="max-w-7xl mx-auto px-8 flex flex-col-reverse lg:flex-row items-center gap-20 z-10">
          ...
          <div className="w-full lg:w-1/2 font-montserrat text-black text-right lg:text-left">
            ...
            <div className="space-y-6 text-lg leading-relaxed text-justify text-gray-800">
              <p>
                Seeing how information was always buried and scattered pushed us
                to think differently. We wanted something that would make life
                easier not only for us but for every student at CIT. That is
                where Katipunan Hub began.
              </p>
              <p>
                ...
                track. Events would be visible on a calendar instead of being
                buried in a feed. Conversations would still exist but in a way
                that kept the important things clear and accessible.
              </p>
              <p>
                Katipunan Hub is our answer to that problem. It is more than a
                school project. It is our way of contributing to the community
                that shaped us. Building this system is also our stepping stone
                as programmers teaching us how to transform a simple idea into
                something that can create real impact.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="w-full min-h-screen flex flex-col relative">
            ...
            <div className="w-[350px] bg-white rounded-[30px] overflow-hidden shadow-2xl transform hover:scale-105 transition-transform duration-300">
              ...
              <div className="p-8 text-left">
                ...
                <p className="text-sm text-gray-700 font-montserrat leading-relaxed mb-8 min-h-[80px]">
                  Focused on building secure and reliable systems for Katipunan
                  Hub. Skilled in Node.js, Supabase, and API integration.
                </p>
        ...
        <div className="bg-[#FFF5E1] border-t-[6px] border-[#EFBF04] relative py-10 px-16">
          ...
          <div
            ...
            style={{
              backgroundImage:
                "radial-gradient(circle, #EFBF04 2px, transparent 2px)",
