...
export default function PanelToggleSwitch({
  ...
  const selectedIndex = currentPanel === "Schedule" ? 0 : 1;
  ...
  const iconScale = currentPanel === "Schedule" ? 1.2 : 1;
      ...
      >
        ...
        <Image 
          ...
          style={{ 
            ...
            transition: 'filter 0.4s, transform 0.4s cubic-bezier(0.68, -0.55, 0.265, 1.55)'
          }}
        />
      </button>
